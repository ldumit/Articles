...
namespace Auth.Persistence.Migrations
{
    ...
    [Migration("20240929053948_InitialCreate")]
            ...
            modelBuilder.Entity("Auth.Domain.Models.RefreshToken", b =>
                {
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("Extension", "Auth.Domain.Models.RefreshToken.Extension#FileExtension", b1 =>
                        {
                            b1.IsRequired();
            ...
            modelBuilder.Entity("Auth.Domain.Models.User", b =>
                {
                    ...
                    b.Property<DateTime>("CreatedOn")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2024, 9, 29, 5, 39, 48, 166, DateTimeKind.Utc).AddTicks(345));
